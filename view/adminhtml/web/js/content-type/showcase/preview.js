...
define(["jquery", "knockout", "mage/translate", "Magento_PageBuilder/js/events", "slick", "underscore", "Magento_PageBuilder/js/config", "Magento_PageBuilder/js/content-type-menu/hide-show-option","Magento_PageBuilder/js/uploader", "Magento_PageBuilder/js/content-type/preview"], function (_jquery, _knockout, _translate, _events, _slick, _underscore, _config, _hideShowOption,_uploader, _preview) {
    /**
        ...
        _proto.afterObservablesUpdated = function afterObservablesUpdated() {
            ...
            if (this.hasDataChanged(this.previousData, data)) {
                ...
                var requestConfig = {
                    ...
                    method: "POST",
                    data: {
                        role: "products", ///orjinali şudur ki : this.config.name,
